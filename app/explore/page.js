...
const ExplorePage = () => {
  ...
  return (
    ...
    >
      ...
      {/* Chat Button - centered above search bar */}
      <div className="fixed bottom-[132px] left-1/2 -translate-x-1/2 z-40">
        <motion.button
        ...
        <div className="max-w-lg mx-auto">
          <div className="relative">
            ...
            <Input
              ...
              className="w-full h-11 rounded-full bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 pl-11 pr-4 text-base placeholder:text-gray-400"
            />
          </div>
        </div>
      </div>
